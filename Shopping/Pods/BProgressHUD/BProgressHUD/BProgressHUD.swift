...
//        backView.userInteractionEnabled = false
    ...
    // singleton
    public class var sharedInstance : BProgressHUD {
        struct Static {
    ...
    public static func showOnlyMessageAutoHide(delay: NSTimeInterval, msg: String, dismissBlock: (() -> Void)?) {
        var hud = BProgressHUD.sharedInstance
    ...
    public class func showSuccessMessageAutoHide(delay: NSTimeInterval, msg: String) {
        BProgressHUD.showSuccessMessageAutoHide(delay, msg: msg, dismissBlock: nil)
    }
    
    public class func showSuccessMessageAutoHide(delay: NSTimeInterval, msg: String, dismissBlock: (() -> Void)?) {
        var hud = BProgressHUD.sharedInstance
        hud.dismissBlock = dismissBlock
        hud.message = msg
    ...
    public class func showErrorMessageAutoHide(delay: NSTimeInterval, msg: String, dismissBlock: (() -> Void)?) {
        var hud = BProgressHUD.sharedInstance
        hud.dismissBlock = dismissBlock
        hud.message = msg
    ...
    public static func dismissHUD(delay: NSTimeInterval) {
        var hud = BProgressHUD.sharedInstance
        hud.dismiss(delay)
    }
